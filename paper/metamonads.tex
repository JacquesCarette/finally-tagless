...
code.  We parameterize our Gaussian Elimination code to great extent
(over domain, matrix representations, determinant tracking and
...
we enjoy MetaOCaml guarantees that the generated code is well-typed.
