...
A more generator |param_code1| has two occurrences of |plus y one|,
...
camlp4 pre-processor, we introduce the |mdo|-notation (cite XXX),
...
Parametrizing by the kind of container representing a matrix is
