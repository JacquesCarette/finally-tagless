...
The combination of stateless modules (functors and structures), and our
monad with the compositional state makes aspects
freely composable without having to worry about the presence or absense of
...
including semantic constraints (e.g., rings do not have full
division).
...
existing piece of code.  Here aspects are weaved together ``from scracth'' to
