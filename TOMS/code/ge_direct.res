        ...
        module type CONTAINER2D =
          sig
            ...
            val augment :
              ...
              ('a, int) Direct.abstract ->
              'a vc -> ('a, int) Direct.abstract -> 'a vc
            val identity :
              ('a, int) Direct.abstract -> ('a, int) Direct.abstract -> 'a vc
            val swap_rows_stmt :
              'a vc ->
                  ...
                  functor (P : TRACKPIVOT) ->
                    sig
                      val findpivot :
                        ...
                        'a curpos ->
                        'b ->
                        ('b -> ('a, C.Dom.v option) Direct.abstract -> 'c) ->
                        'c
                    end
              ...
              module type INPUT =
                sig
                  ...
                  val get_input :
                    ('a, inp) Direct.abstract ->
                    (('a, C.contr) Direct.abstract *
                     ('a, rhs) Direct.abstract, 'b, ('a, 'c) Direct.abstract)
                    StateCPSMonad.monad
                end
              ...
              module type OUTPUT =
                sig
                  ...
                  val make_result :
                    ...
                    ('a, int) Direct.abstract ->
                    ('a, int) Direct.abstract ->
                    ('a, int) Direct.abstract -> ('a, res, 'b, 'c) cmonad
                end
...
module GVC_F :
  sig
    ...
    val augment :
      (unit -> Dom.v Domains_direct.container2dfromvector) ->
      (unit -> int) ->
      (unit -> int) ->
      (unit -> Dom.v Domains_direct.container2dfromvector) ->
      (unit -> int) -> unit -> Dom.v Domains_direct.container2dfromvector
...
module GFC_F :
  sig
    ...
    val augment :
      ...
      ('a, int) Domains_direct.DirectRep.rep ->
      ('a, int) Domains_direct.DirectRep.rep ->
      'a vc -> ('a, int) Domains_direct.DirectRep.rep -> 'a vc
    val identity :
      ('a, int) Domains_direct.DirectRep.rep ->
      ('a, int) Domains_direct.DirectRep.rep -> 'a vc
    val swap_rows_stmt :
...
module G_GAC_F :
  sig
    type 'a wmatrix =
      'a Ge.LAMake(Direct).GenLA(GAC_F).wmatrix = {
      matrix : 'a GAC_F.vc;
      numrow : ('a, int) Direct.abstract;
      numcol : ('a, int) Direct.abstract;
    }
    type 'a curpos =
      'a Ge.LAMake(Direct).GenLA(GAC_F).curpos = {
      rowpos : ('a, int) Direct.abstract;
      colpos : ('a, int) Direct.abstract;
    }
    type 'a curposval =
      'a Ge.LAMake(Direct).GenLA(GAC_F).curposval = {
      p : 'a curpos;
        ...
        module InpJustMatrix :
          sig
            ...
            val get_input :
              'a GAC_F.vc ->
              'b ->
              ('b -> 'a GAC_F.vc * ('a, int) Direct.abstract * bool -> 'c) ->
              'c
          end
        module InpMatrixMargin :
          sig
            ...
            functor (P : GEF.TRACKPIVOT) ->
              sig
                val findpivot :
                  ...
                  'a curpos ->
                  'b ->
                  ('b -> ('a, GAC_F.Dom.v option) Direct.abstract -> 'c) ->
                  'c
              end
        module type OUTPUTDEP =
      ...
      sig
        module type INPUT =
          sig
            ...
            val get_input :
              ('a, inp) Direct.abstract ->
              (('a, GAC_F.contr) Direct.abstract * ('a, rhs) Direct.abstract,
        ...
        module type OUTPUT =
          sig
            ...
            val make_result :
              ...
              ('a, int) Direct.abstract ->
              ('a, int) Direct.abstract ->
              ('a, int) Direct.abstract -> ('a, res, 'b, 'c) GEF.cmonad
          end
        module OutJustAnswer :
          sig
            type res = GAC_F.contr
...
module G_GVC_F :
  sig
    type 'a wmatrix =
      'a Ge.LAMake(Direct).GenLA(GVC_F).wmatrix = {
      matrix : 'a GVC_F.vc;
      numrow : ('a, int) Direct.abstract;
      numcol : ('a, int) Direct.abstract;
    }
    type 'a curpos =
      'a Ge.LAMake(Direct).GenLA(GVC_F).curpos = {
      rowpos : ('a, int) Direct.abstract;
      colpos : ('a, int) Direct.abstract;
    }
    type 'a curposval =
      'a Ge.LAMake(Direct).GenLA(GVC_F).curposval = {
      p : 'a curpos;
        ...
        module InpJustMatrix :
          sig
            ...
            val get_input :
              'a GVC_F.vc ->
              'b ->
              ('b -> 'a GVC_F.vc * ('a, int) Direct.abstract * bool -> 'c) ->
              'c
          end
        module InpMatrixMargin :
          sig
            ...
            functor (P : GEF.TRACKPIVOT) ->
              sig
                val findpivot :
                  ...
                  'a curpos ->
                  'b ->
                  ('b -> ('a, GVC_F.Dom.v option) Direct.abstract -> 'c) ->
                  'c
              end
        module type OUTPUTDEP =
          sig module PivotRep : GEF.PIVOTKIND module Det : DETERMINANT end
      ...
      sig
        module type INPUT =
          sig
            ...
            val get_input :
              ('a, inp) Direct.abstract ->
              (('a, GVC_F.contr) Direct.abstract * ('a, rhs) Direct.abstract,
               'b, ('a, 'c) Direct.abstract)
              StateCPSMonad.monad
          end
        module InpMatrixVector :
...
module G_GAC_I :
  sig
    type 'a wmatrix =
      'a Ge.LAMake(Direct).GenLA(GAC_I).wmatrix = {
      matrix : 'a GAC_I.vc;
      numrow : ('a, int) Direct.abstract;
      numcol : ('a, int) Direct.abstract;
    }
    type 'a curpos =
      'a Ge.LAMake(Direct).GenLA(GAC_I).curpos = {
      rowpos : ('a, int) Direct.abstract;
      colpos : ('a, int) Direct.abstract;
    }
    type 'a curposval =
      'a Ge.LAMake(Direct).GenLA(GAC_I).curposval = {
      p : 'a curpos;
        ...
        module InpJustMatrix :
          sig
            ...
            val get_input :
              'a GAC_I.vc ->
              'b ->
              ('b -> 'a GAC_I.vc * ('a, int) Direct.abstract * bool -> 'c) ->
              'c
          end
        module InpMatrixMargin :
          sig
            ...
            functor (P : GEF.TRACKPIVOT) ->
              sig
                val findpivot :
                  ...
                  'a curpos ->
                  'b ->
                  ('b -> ('a, GAC_I.Dom.v option) Direct.abstract -> 'c) ->
                  'c
              end
        module type OUTPUTDEP =
          sig module PivotRep : GEF.PIVOTKIND module Det : DETERMINANT end
      ...
      sig
        module type INPUT =
          sig
            ...
            val get_input :
              ('a, inp) Direct.abstract ->
              (('a, GAC_I.contr) Direct.abstract * ('a, rhs) Direct.abstract,
               'b, ('a, 'c) Direct.abstract)
              StateCPSMonad.monad
          end
        module InpMatrixVector :
...
module G_GVC_I :
  sig
    type 'a wmatrix =
      'a Ge.LAMake(Direct).GenLA(GVC_I).wmatrix = {
      matrix : 'a GVC_I.vc;
      numrow : ('a, int) Direct.abstract;
      numcol : ('a, int) Direct.abstract;
    }
    type 'a curpos =
      'a Ge.LAMake(Direct).GenLA(GVC_I).curpos = {
      rowpos : ('a, int) Direct.abstract;
      colpos : ('a, int) Direct.abstract;
    }
    type 'a curposval =
      'a Ge.LAMake(Direct).GenLA(GVC_I).curposval = {
      p : 'a curpos;
        ...
        module InpJustMatrix :
          sig
            ...
            val get_input :
              'a GVC_I.vc ->
              'b ->
              ('b -> 'a GVC_I.vc * ('a, int) Direct.abstract * bool -> 'c) ->
              'c
          end
        module InpMatrixMargin :
          sig
            ...
            functor (P : GEF.TRACKPIVOT) ->
              sig
                val findpivot :
                  ...
                  'a curpos ->
                  'b ->
                  ('b -> ('a, GVC_I.Dom.v option) Direct.abstract -> 'c) ->
                  'c
              end
        module type OUTPUTDEP =
          sig module PivotRep : GEF.PIVOTKIND module Det : DETERMINANT end
      ...
      sig
        module type INPUT =
          sig
            ...
            val get_input :
              ('a, inp) Direct.abstract ->
              (('a, GVC_I.contr) Direct.abstract * ('a, rhs) Direct.abstract,
               'b, ('a, 'c) Direct.abstract)
              StateCPSMonad.monad
          end
        module InpMatrixVector :
...
module G_GAC_R :
  sig
    type 'a wmatrix =
      'a Ge.LAMake(Direct).GenLA(GAC_R).wmatrix = {
      matrix : 'a GAC_R.vc;
      numrow : ('a, int) Direct.abstract;
      numcol : ('a, int) Direct.abstract;
    }
    type 'a curpos =
      'a Ge.LAMake(Direct).GenLA(GAC_R).curpos = {
      rowpos : ('a, int) Direct.abstract;
      colpos : ('a, int) Direct.abstract;
    }
    type 'a curposval =
      'a Ge.LAMake(Direct).GenLA(GAC_R).curposval = {
      p : 'a curpos;
        ...
        module InpJustMatrix :
          sig
            ...
            val get_input :
              'a GAC_R.vc ->
              'b ->
              ('b -> 'a GAC_R.vc * ('a, int) Direct.abstract * bool -> 'c) ->
              'c
          end
        module InpMatrixMargin :
          sig
            ...
            functor (P : GEF.TRACKPIVOT) ->
              sig
                val findpivot :
                  ...
                  'a curpos ->
                  'b ->
                  ('b -> ('a, GAC_R.Dom.v option) Direct.abstract -> 'c) ->
                  'c
              end
        module type OUTPUTDEP =
          sig module PivotRep : GEF.PIVOTKIND module Det : DETERMINANT end
      ...
      sig
        module type INPUT =
          sig
            ...
            val get_input :
              ('a, inp) Direct.abstract ->
              (('a, GAC_R.contr) Direct.abstract * ('a, rhs) Direct.abstract,
               'b, ('a, 'c) Direct.abstract)
              StateCPSMonad.monad
          end
        module InpMatrixVector :
...
module G_GVC_Z3 :
  sig
    type 'a wmatrix =
      'a Ge.LAMake(Direct).GenLA(GVC_Z3).wmatrix = {
      matrix : 'a GVC_Z3.vc;
      numrow : ('a, int) Direct.abstract;
      numcol : ('a, int) Direct.abstract;
    }
    type 'a curpos =
      'a Ge.LAMake(Direct).GenLA(GVC_Z3).curpos = {
      rowpos : ('a, int) Direct.abstract;
      colpos : ('a, int) Direct.abstract;
    }
    type 'a curposval =
      'a Ge.LAMake(Direct).GenLA(GVC_Z3).curposval = {
      p : 'a curpos;
        ...
        module InpJustMatrix :
          sig
            ...
            val get_input :
              'a GVC_Z3.vc ->
              'b ->
              ('b -> 'a GVC_Z3.vc * ('a, int) Direct.abstract * bool -> 'c) ->
              'c
          end
        module InpMatrixMargin :
          sig
            ...
            functor (P : GEF.TRACKPIVOT) ->
              sig
                val findpivot :
                  ...
                  'a curpos ->
                  'b ->
                  ('b -> ('a, GVC_Z3.Dom.v option) Direct.abstract -> 'c) ->
                  'c
              end
        module type OUTPUTDEP =
          sig module PivotRep : GEF.PIVOTKIND module Det : DETERMINANT end
      ...
      sig
        module type INPUT =
          sig
            ...
            val get_input :
              ('a, inp) Direct.abstract ->
              (('a, GVC_Z3.contr) Direct.abstract * ('a, rhs) Direct.abstract,
               'b, ('a, 'c) Direct.abstract)
              StateCPSMonad.monad
          end
        module InpMatrixVector :
...
module G_GVC_Z19 :
  sig
    type 'a wmatrix =
      'a Ge.LAMake(Direct).GenLA(GVC_Z19).wmatrix = {
      matrix : 'a GVC_Z19.vc;
      numrow : ('a, int) Direct.abstract;
      numcol : ('a, int) Direct.abstract;
    }
    type 'a curpos =
      'a Ge.LAMake(Direct).GenLA(GVC_Z19).curpos = {
      rowpos : ('a, int) Direct.abstract;
      colpos : ('a, int) Direct.abstract;
    }
    type 'a curposval =
      'a Ge.LAMake(Direct).GenLA(GVC_Z19).curposval = {
      p : 'a curpos;
            ...
            functor (P : GEF.TRACKPIVOT) ->
              sig
                val findpivot :
                  ...
                  'a curpos ->
                  'b ->
                  ('b -> ('a, GVC_Z19.Dom.v option) Direct.abstract -> 'c) ->
                  'c
              end
        module type OUTPUTDEP =
          sig module PivotRep : GEF.PIVOTKIND module Det : DETERMINANT end
...
module G_GFC_F :
  sig
    type 'a wmatrix =
      'a Ge.LAMake(Direct).GenLA(GFC_F).wmatrix = {
      matrix : 'a GFC_F.vc;
      numrow : ('a, int) Direct.abstract;
      numcol : ('a, int) Direct.abstract;
    }
    type 'a curpos =
      'a Ge.LAMake(Direct).GenLA(GFC_F).curpos = {
      rowpos : ('a, int) Direct.abstract;
      colpos : ('a, int) Direct.abstract;
    }
    type 'a curposval =
      'a Ge.LAMake(Direct).GenLA(GFC_F).curposval = {
      p : 'a curpos;
        ...
        module InpJustMatrix :
          sig
            ...
            val get_input :
              'a GFC_F.vc ->
              'b ->
              ('b -> 'a GFC_F.vc * ('a, int) Direct.abstract * bool -> 'c) ->
              'c
          end
        module InpMatrixMargin :
          sig
            ...
            functor (P : GEF.TRACKPIVOT) ->
              sig
                val findpivot :
                  ...
                  'a curpos ->
                  'b ->
                  ('b -> ('a, GFC_F.Dom.v option) Direct.abstract -> 'c) ->
                  'c
              end
        module type OUTPUTDEP =
          sig module PivotRep : GEF.PIVOTKIND module Det : DETERMINANT end
      ...
      sig
        module type INPUT =
          sig
            ...
            val get_input :
              ('a, inp) Direct.abstract ->
              (('a, GFC_F.contr) Direct.abstract * ('a, rhs) Direct.abstract,
               'b, ('a, 'c) Direct.abstract)
              StateCPSMonad.monad
          end
        module InpMatrixVector :
