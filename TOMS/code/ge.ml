...
module OutRank(Rank : RANK)(C: CONTAINER2D)(Det: DETERMINANT) = 
  struct
...
module OutDetRank(Rank : RANK)(C: CONTAINER2D)(Det : DETERMINANT) =
  struct
...
module OutDetRankPivot(Rank: RANK)(C: CONTAINER2D)
    (Det : DETERMINANT) =
  struct
