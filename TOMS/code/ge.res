  ...
  sig
    ...
    module NoRank :
      sig
        ...
        val fin : unit -> 'a -> ('a -> ('b, int) Code.abstract -> 'c) -> 'c
      end
    module NoDet :
    ...
    module type PIVOTKIND =
      sig
        ...
        type flip_rep
        type perm_rep
        type 'a ira = ('a, idx_rep) Code.abstract
    ...
    module type TRACKPIVOT =
      sig
        ...
        type 'a fra = ('a, flip_rep) Code.abstract
        type 'a pra = ('a, perm_rep) Code.abstract
        type 'a lstate = ('a, perm_rep ref) Code.abstract
        ...
        val fin :
          unit ->
          ('a pra option, [> 'a tag_lstate ] list, ('a, 'b) Code.abstract)
          StateCPSMonad.monad
      end
    module PivotCommon :
    ...
    module FractionFreeUpdate :
      functor (Ctr : D.CONTAINER2D) ->
        functor (Det : DETF) ->
          sig
            type 'a in_val = ('a, Ctr.Dom.v) Code.abstract
                ...
                functor (PK : PIVOTKIND) ->
                  sig
                    ...
                    val make_result :
                      ...
                      ('b list ->
                       ('a, C.contr * Det.outdet) Code.abstract ->
                       ('a, 'c) Code.abstract) ->
                      ('a, 'c) Code.abstract
                  end
          module OutRank :
                ...
                functor (PK : PIVOTKIND) ->
                  sig
                    ...
                    val make_result :
                      ...
                      ('b list -> ('a, C.contr * 'c) Code.abstract -> 'd) ->
                      'd
                  end
          module OutDetRank :
            functor (C0 : D.CONTAINER2D) ->
                ...
                functor (PK : PIVOTKIND) ->
                  sig
                    ...
                    val make_result :
                      ...
                      list ->
                      ('b list ->
                       ('a, C.contr * Det.outdet * 'c) Code.abstract ->
                       ('a, 'd) Code.abstract) ->
                      ('a, 'd) Code.abstract
                  end
                  ...
                  sig
                    ...
                    module P :
                      sig
                        ...
                        val decl :
                          'a PK.ira ->
                          ([> `TPivot of ('a, PK.perm_rep ref) Code.abstract ]
                           as 'b)
                          list ->
                          ('b list ->
                    ...
                    val make_result :
                      ...
                      list ->
                      ('b list ->
                       ('a, C.contr * Det.outdet * 'd * 'c) Code.abstract ->
                       ('a, 'e) Code.abstract) ->
                      ('a, 'e) Code.abstract
                  end
          module Out_L_U :
  ...
  sig
    module Dom :
      sig
        ...
        type kind =
            Domains_code.FortranVectorContainer(Domains_code.FloatDomainL).Dom.kind
        val zero : v
        val one : v
        val plus : v -> v -> v
        val times : v -> v -> v
            ...
            sig
              ...
              module R :
                sig
                  ...
                  val fin :
                    unit -> 'a -> ('a -> ('b, int) Code.abstract -> 'c) -> 'c
                end
              module P :
                sig
                  type idx_rep = PK.idx_rep
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                ([> 'a Det.tag_lstate ] as 'b) list ->
                ('b list ->
                 ('a, GAC_F.contr * Det.outdet) Code.abstract ->
                 ('a, 'c) Code.abstract) ->
                ('a, 'c) Code.abstract
            end
    module OutRank :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GAC_F.contr * Det.outdet * 'c) Code.abstract ->
                 ('a, 'd) Code.abstract) ->
                ('a, 'd) Code.abstract
            end
    module OutDetRankPivot :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GAC_F.contr * Det.outdet * 'd * 'c) Code.abstract ->
                 ('a, 'e) Code.abstract) ->
                ('a, 'e) Code.abstract
            end
    module Out_L_U :
        ...
        functor (P : GEF.TRACKPIVOT) ->
          sig
            val findpivot :
              'a wmatrix ->
              'a curpos ->
              ([> `TDet of 'a Det(GAC_F.Dom).lstate | `TPivot of 'a P.lstate ]
               as 'b)
              list ->
              ('b list ->
        ...
        functor (PK : GEF.PIVOTKIND) ->
          functor (Detf : GEF.DETF) ->
            functor (Update : GEF.UpdateProxy(GAC_F)(Detf).S) ->
              functor (Input : INPUT) ->
                functor (Out : OutProxy(GAC_F)(Detf).S) ->
                  sig
                    module Det :
                      sig
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                ([> 'a Det.tag_lstate ] as 'b) list ->
                ('b list ->
                 ('a, GVC_F.contr * Det.outdet) Code.abstract ->
                 ('a, 'c) Code.abstract) ->
                ('a, 'c) Code.abstract
            end
    module OutRank :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GVC_F.contr * Det.outdet * 'c) Code.abstract ->
                 ('a, 'd) Code.abstract) ->
                ('a, 'd) Code.abstract
            end
    module OutDetRankPivot :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GVC_F.contr * Det.outdet * 'd * 'c) Code.abstract ->
                 ('a, 'e) Code.abstract) ->
                ('a, 'e) Code.abstract
            end
    module Out_L_U :
        ...
        functor (P : GEF.TRACKPIVOT) ->
          sig
            val findpivot :
              'a wmatrix ->
              'a curpos ->
              ([> `TDet of 'a Det(GVC_F.Dom).lstate | `TPivot of 'a P.lstate ]
               as 'b)
              list ->
              ('b list ->
        ...
        functor (PK : GEF.PIVOTKIND) ->
          functor (Detf : GEF.DETF) ->
            functor (Update : GEF.UpdateProxy(GVC_F)(Detf).S) ->
              functor (Input : INPUT) ->
                functor (Out : OutProxy(GVC_F)(Detf).S) ->
                  sig
                    module Det :
                      sig
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                ([> 'a Det.tag_lstate ] as 'b) list ->
                ('b list ->
                 ('a, GAC_I.contr * Det.outdet) Code.abstract ->
                 ('a, 'c) Code.abstract) ->
                ('a, 'c) Code.abstract
            end
    module OutRank :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GAC_I.contr * Det.outdet * 'c) Code.abstract ->
                 ('a, 'd) Code.abstract) ->
                ('a, 'd) Code.abstract
            end
    module OutDetRankPivot :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GAC_I.contr * Det.outdet * 'd * 'c) Code.abstract ->
                 ('a, 'e) Code.abstract) ->
                ('a, 'e) Code.abstract
            end
    module Out_L_U :
        ...
        functor (P : GEF.TRACKPIVOT) ->
          sig
            val findpivot :
              'a wmatrix ->
              'a curpos ->
              ([> `TDet of 'a Det(GAC_I.Dom).lstate | `TPivot of 'a P.lstate ]
               as 'b)
              list ->
              ('b list ->
        ...
        functor (PK : GEF.PIVOTKIND) ->
          functor (Detf : GEF.DETF) ->
            functor (Update : GEF.UpdateProxy(GAC_I)(Detf).S) ->
              functor (Input : INPUT) ->
                functor (Out : OutProxy(GAC_I)(Detf).S) ->
                  sig
                    module Det :
                      sig
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                ([> 'a Det.tag_lstate ] as 'b) list ->
                ('b list ->
                 ('a, GVC_I.contr * Det.outdet) Code.abstract ->
                 ('a, 'c) Code.abstract) ->
                ('a, 'c) Code.abstract
            end
    module OutRank :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GVC_I.contr * Det.outdet * 'c) Code.abstract ->
                 ('a, 'd) Code.abstract) ->
                ('a, 'd) Code.abstract
            end
    module OutDetRankPivot :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GVC_I.contr * Det.outdet * 'd * 'c) Code.abstract ->
                 ('a, 'e) Code.abstract) ->
                ('a, 'e) Code.abstract
            end
    module Out_L_U :
        ...
        functor (P : GEF.TRACKPIVOT) ->
          sig
            val findpivot :
              'a wmatrix ->
              'a curpos ->
              ([> `TDet of 'a Det(GVC_I.Dom).lstate | `TPivot of 'a P.lstate ]
               as 'b)
              list ->
              ('b list ->
        ...
        functor (PK : GEF.PIVOTKIND) ->
          functor (Detf : GEF.DETF) ->
            functor (Update : GEF.UpdateProxy(GVC_I)(Detf).S) ->
              functor (Input : INPUT) ->
                functor (Out : OutProxy(GVC_I)(Detf).S) ->
                  sig
                    module Det :
                      sig
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                ([> 'a Det.tag_lstate ] as 'b) list ->
                ('b list ->
                 ('a, GAC_R.contr * Det.outdet) Code.abstract ->
                 ('a, 'c) Code.abstract) ->
                ('a, 'c) Code.abstract
            end
    module OutRank :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GAC_R.contr * Det.outdet * 'c) Code.abstract ->
                 ('a, 'd) Code.abstract) ->
                ('a, 'd) Code.abstract
            end
    module OutDetRankPivot :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GAC_R.contr * Det.outdet * 'd * 'c) Code.abstract ->
                 ('a, 'e) Code.abstract) ->
                ('a, 'e) Code.abstract
            end
    module Out_L_U :
        ...
        functor (P : GEF.TRACKPIVOT) ->
          sig
            val findpivot :
              'a wmatrix ->
              'a curpos ->
              ([> `TDet of 'a Det(GAC_R.Dom).lstate | `TPivot of 'a P.lstate ]
               as 'b)
              list ->
              ('b list ->
        ...
        functor (PK : GEF.PIVOTKIND) ->
          functor (Detf : GEF.DETF) ->
            functor (Update : GEF.UpdateProxy(GAC_R)(Detf).S) ->
              functor (Input : INPUT) ->
                functor (Out : OutProxy(GAC_R)(Detf).S) ->
                  sig
                    module Det :
                      sig
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                ([> 'a Det.tag_lstate ] as 'b) list ->
                ('b list ->
                 ('a, GVC_Z3.contr * Det.outdet) Code.abstract ->
                 ('a, 'c) Code.abstract) ->
                ('a, 'c) Code.abstract
            end
    module OutRank :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                'a wmatrix ->
                ([> `TRan of ('a, 'c ref) Code.abstract ] as 'b) list ->
                ('b list -> ('a, GVC_Z3.contr * 'c) Code.abstract -> 'd) ->
                'd
            end
    module OutDetRank :
      functor (C0 : GEF.D.CONTAINER2D) ->
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GVC_Z3.contr * Det.outdet * 'c) Code.abstract ->
                 ('a, 'd) Code.abstract) ->
                ('a, 'd) Code.abstract
            end
    module OutDetRankPivot :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GVC_Z3.contr * Det.outdet * 'd * 'c) Code.abstract ->
                 ('a, 'e) Code.abstract) ->
                ('a, 'e) Code.abstract
            end
    module Out_L_U :
        ...
        functor (P : GEF.TRACKPIVOT) ->
          sig
            val findpivot :
              'a wmatrix ->
              'a curpos ->
              ([> `TDet of 'a Det(GVC_Z3.Dom).lstate | `TPivot of 'a P.lstate ]
               as 'b)
              list ->
              ('b list ->
        ...
        functor (PK : GEF.PIVOTKIND) ->
          functor (Detf : GEF.DETF) ->
            functor (Update : GEF.UpdateProxy(GVC_Z3)(Detf).S) ->
              functor (Input : INPUT) ->
                functor (Out : OutProxy(GVC_Z3)(Detf).S) ->
                  sig
                    module Det :
                      sig
                    ...
                    module Output :
                      sig
                        type res = Out(GVC_Z3)(Det)(PK).res
                        module R :
                          sig
                            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
                            val rfetch :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                ([> 'a Det.tag_lstate ] as 'b) list ->
                ('b list ->
                 ('a, GVC_Z19.contr * Det.outdet) Code.abstract ->
                 ('a, 'c) Code.abstract) ->
                ('a, 'c) Code.abstract
            end
    module OutRank :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                'a wmatrix ->
                ([> `TRan of ('a, 'c ref) Code.abstract ] as 'b) list ->
                ('b list -> ('a, GVC_Z19.contr * 'c) Code.abstract -> 'd) ->
                'd
            end
    module OutDetRank :
      functor (C0 : GEF.D.CONTAINER2D) ->
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GVC_Z19.contr * Det.outdet * 'c) Code.abstract ->
                 ('a, 'd) Code.abstract) ->
                ('a, 'd) Code.abstract
            end
    module OutDetRankPivot :
          ...
          functor (PK : GEF.PIVOTKIND) ->
            sig
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GVC_Z19.contr * Det.outdet * 'd * 'c) Code.abstract ->
                 ('a, 'e) Code.abstract) ->
                ('a, 'e) Code.abstract
            end
    module Out_L_U :
        ...
        functor (P : GEF.TRACKPIVOT) ->
          sig
            val findpivot :
              'a wmatrix ->
              'a curpos ->
              ([> `TDet of 'a Det(GVC_Z19.Dom).lstate
                | `TPivot of 'a P.lstate ]
               as 'b)
              list ->
              ('b list ->
        ...
        functor (PK : GEF.PIVOTKIND) ->
          functor (Detf : GEF.DETF) ->
            functor (Update : GEF.UpdateProxy(GVC_Z19)(Detf).S) ->
              functor (Input : INPUT) ->
                functor (Out : OutProxy(GVC_Z19)(Detf).S) ->
                  sig
                    module Det :
                      sig
                    ...
                    module Output :
                      sig
                        type res = Out(GVC_Z19)(Det)(PK).res
                        module R :
                          sig
                            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
                            val rfetch :
  ...
  sig
    ...
    module type LOWER =
      sig
        ...
        val fin : unit -> ('a * [> 'a tag_lstate ] * 'b, GFC_F.contr) om
        val wants_pack : bool
      end
    module TrackLower :
      sig
    ...
    module OutDet :
      functor (C0 : GEF.D.CONTAINER2D) ->
        functor (Det : GEF.DETERMINANT) ->
          functor (PK : GEF.PIVOTKIND) ->
            sig
              type res = GFC_F.contr * Det.outdet
              module R :
                sig
                  type 'a lstate = ('a, int ref) Code.abstract
                  type 'a tag_lstate_ = [ `TRan of 'a lstate ]
              ...
              val make_result :
                ...
                ([> 'a Det.tag_lstate ] as 'b) list ->
                ('b list ->
                 ('a, GFC_F.contr * Det.outdet) Code.abstract ->
                 ('a, 'c) Code.abstract) ->
                ('a, 'c) Code.abstract
            end
    module OutRank :
    ...
    module OutDetRank :
      functor (C0 : GEF.D.CONTAINER2D) ->
        functor (Det : GEF.DETERMINANT) ->
          functor (PK : GEF.PIVOTKIND) ->
            sig
              type res = GFC_F.contr * Det.outdet * int
              module R :
                sig
                  type 'a lstate = ('a, int ref) Code.abstract
                  type 'a tag_lstate_ = [ `TRan of 'a lstate ]
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GFC_F.contr * Det.outdet * 'c) Code.abstract ->
                 ('a, 'd) Code.abstract) ->
                ('a, 'd) Code.abstract
            end
    module OutDetRankPivot :
      functor (C0 : GEF.D.CONTAINER2D) ->
        functor (Det : GEF.DETERMINANT) ->
          functor (PK : GEF.PIVOTKIND) ->
            sig
              type res = GFC_F.contr * Det.outdet * int * PK.perm_rep
              module R :
                sig
                  type 'a lstate = ('a, int ref) Code.abstract
                  type 'a tag_lstate_ = [ `TRan of 'a lstate ]
              ...
              val make_result :
                ...
                list ->
                ('b list ->
                 ('a, GFC_F.contr * Det.outdet * 'd * 'c) Code.abstract ->
                 ('a, 'e) Code.abstract) ->
                ('a, 'e) Code.abstract
            end
    module Out_L_U :
      functor
        ...
        functor (Det : GEF.DETERMINANT) ->
          functor (PK : GEF.PIVOTKIND) ->
            sig
              type res = GFC_F.contr * GFC_F.contr * PK.perm_rep
              module R :
                sig
                  type 'a lstate = ('a, int ref) Code.abstract
                  type 'a tag_lstate_ = [ `TRan of 'a lstate ]
    ...
    module Out_LU_Packed :
      functor
        ...
        functor (Det : GEF.DETERMINANT) ->
          functor (PK : GEF.PIVOTKIND) ->
            sig
              type res = GFC_F.contr * PK.perm_rep
              module R :
                sig
                  type 'a lstate = ('a, int ref) Code.abstract
                  type 'a tag_lstate_ = [ `TRan of 'a lstate ]
          ...
          sig
            val findpivot :
              ...
              ('a, GFC_F.Dom.v option,
               [> `TDet of 'a D(GFC_F.Dom).lstate | `TPivot of 'a P.lstate ],
               'b)
              GEF.cmonad
          end
    module RowPivot :
        ...
        functor (P : GEF.TRACKPIVOT) ->
          sig
            val findpivot :
              'a wmatrix ->
              'a curpos ->
              ([> `TDet of 'a Det(GFC_F.Dom).lstate | `TPivot of 'a P.lstate ]
               as 'b)
              list ->
              ('b list ->
    ...
    module GenGE :
      functor (PivotF : PIVOT) ->
        functor (PK : GEF.PIVOTKIND) ->
          functor (Detf : GEF.DETF) ->
            functor (Update : GEF.UpdateProxy(GFC_F)(Detf).S) ->
              functor (Input : INPUT) ->
                functor (Out : OutProxy(GFC_F)(Detf).S) ->
                  sig
                    module Det :
                      sig
                        type indet = GFC_F.Dom.v
                        type outdet = Detf(GFC_F.Dom).outdet
                        type tdet = outdet ref
                        type 'a lstate = 'a Detf(GFC_F.Dom).lstate
                        type 'a tag_lstate = [ `TDet of 'a lstate ]
                        type ('a, 'b) lm = ('c, 'b, 'd, 'e) GEF.cmonad
                          constraint 'a =
                            'c * ([> 'c tag_lstate ] as 'd) * 'e
                    ...
                    module U :
                      sig
                        ...
                        type out_val = Detf(GFC_F.Dom).outdet
                        val update :
                          'a in_val ->
                          'a in_val ->
                          'a in_val ->
                      ...
                      sig
                        ...
                        module L :
                          sig
                            ...
                            val fin :
                              unit ->
                              ('a * [> 'a tag_lstate ] * 'b, GFC_F.contr) om
                            val wants_pack : bool
                          end
                        val make_result :
                          'a wmatrix ->
                    ...
                    module Pivot :
                      sig
                        val findpivot :
                          ...
                          'a curpos ->
                          ('a, GFC_F.Dom.v option,
                           [> `TDet of 'a Detf(GFC_F.Dom).lstate
                            | `TPivot of 'a Output.P.lstate ],
                           'b)
                          GEF.cmonad
                      end
...
module GenFA1 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_F.OutJustMatrix(GAC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
    ...
    val gen :
      ('a, G_GAC_F.InpJustMatrix.inp) Code.abstract ->
      ([> `TDet of 'a Det.lstate
        | `TLower of 'a Output.L.lstate
        | `TPivot of 'a Output.P.lstate
        | `TRan of 'a GEF.TrackRank.lstate ]
...
module GenFA2 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_F.OutDet(GAC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenFA3 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_F.OutRank(GAC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenFA4 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_F.OutDetRank(GAC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenFA24 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_F.OutDetRankPivot(GAC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenFA25 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_F.OutDetRankPivot(GAC_F)(Det)(GEF.RowVectorPerm).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenFA26 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_F.OutJustMatrix(GAC_F)(Det)(GEF.RowVectorPerm).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenFA5 :
  sig
    ...
    val gen :
      ('a, G_GAC_F.InpMatrixMargin.inp) Code.abstract ->
      ([> `TDet of 'a Det.lstate
        | `TLower of 'a Output.L.lstate
        | `TPivot of 'a Output.P.lstate
        | `TRan of 'a GEF.TrackRank.lstate ]
...
module GenFA9 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_F.Out_LU_Packed(GAC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenFA31 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_F.Out_L_U(GAC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenFV1 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_F.OutJustMatrix(GVC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
    ...
    val gen :
      ('a, G_GVC_F.InpJustMatrix.inp) Code.abstract ->
      ([> `TDet of 'a Det.lstate
        | `TLower of 'a Output.L.lstate
        | `TPivot of 'a Output.P.lstate
        | `TRan of 'a GEF.TrackRank.lstate ]
...
module GenFV2 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_F.OutDet(GVC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenFV3 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_F.OutRank(GVC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenFV4 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_F.OutDetRank(GVC_F)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenIA1 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_I.OutJustMatrix(GAC_I)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
    ...
    val gen :
      ('a, G_GAC_I.InpJustMatrix.inp) Code.abstract ->
      ([> `TDet of 'a Det.lstate
        | `TLower of 'a Output.L.lstate
        | `TPivot of 'a Output.P.lstate
        | `TRan of 'a GEF.TrackRank.lstate ]
...
module GenIA2 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_I.OutDet(GAC_I)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenIA3 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_I.OutRank(GAC_I)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenIA4 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_I.OutDetRank(GAC_I)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenIV1 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_I.OutJustMatrix(GVC_I)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
    ...
    val gen :
      ('a, G_GVC_I.InpJustMatrix.inp) Code.abstract ->
      ([> `TDet of 'a Det.lstate
        | `TLower of 'a Output.L.lstate
        | `TPivot of 'a Output.P.lstate
        | `TRan of 'a GEF.TrackRank.lstate ]
...
module GenIV2 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_I.OutDet(GVC_I)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenIV3 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_I.OutRank(GVC_I)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenIV4 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_I.OutDetRank(GVC_I)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenIV6 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_I.OutDetRankPivot(GVC_I)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenRA1 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_R.OutJustMatrix(GAC_R)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
    ...
    val gen :
      ('a, G_GAC_R.InpJustMatrix.inp) Code.abstract ->
      ([> `TDet of 'a Det.lstate
        | `TLower of 'a Output.L.lstate
        | `TPivot of 'a Output.P.lstate
        | `TRan of 'a GEF.TrackRank.lstate ]
...
module GenRA2 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_R.OutDet(GAC_R)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenRA3 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_R.OutRank(GAC_R)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenRA4 :
  sig
    ...
    module Output :
      sig
        type res = G_GAC_R.OutDetRank(GAC_R)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
...
module GenZp3 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_Z3.OutDetRankPivot(GVC_Z3)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
    ...
    val gen :
      ('a, G_GVC_Z3.InpJustMatrix.inp) Code.abstract ->
      ([> `TDet of 'a Det.lstate
        | `TLower of 'a Output.L.lstate
        | `TPivot of 'a Output.P.lstate
        | `TRan of 'a GEF.TrackRank.lstate ]
...
module GenZp19 :
  sig
    ...
    module Output :
      sig
        type res = G_GVC_Z19.OutDetRankPivot(GVC_Z19)(Det)(GEF.PermList).res
        module R :
          sig
            type 'a tag_lstate = 'a GEF.TrackRank.tag_lstate_
            val rfetch :
    ...
    val gen :
      ('a, G_GVC_Z19.InpJustMatrix.inp) Code.abstract ->
      ([> `TDet of 'a Det.lstate
        | `TLower of 'a Output.L.lstate
        | `TPivot of 'a Output.P.lstate
        | `TRan of 'a GEF.TrackRank.lstate ]
...
val resFA1 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA1.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   ...
   t_5>.
val resFA2 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA2.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
...
val resFA3 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA3.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   (t_5, (! t_2))>.
val resFA4 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA4.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
...
val resFV1 : ('a, G_GVC_F.InpJustMatrix.inp -> GenFV1.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   ...
   t_4>.
val resFV2 : ('a, G_GVC_F.InpJustMatrix.inp -> GenFV2.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
...
val resFV3 : ('a, G_GVC_F.InpJustMatrix.inp -> GenFV3.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
   ...
   (t_4, (! t_2))>.
val resFV4 : ('a, G_GVC_F.InpJustMatrix.inp -> GenFV4.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
...
val resFV5 : ('a, G_GVC_F.InpJustMatrix.inp -> GenFV5.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
...
val resIA1 : ('a, G_GAC_I.InpJustMatrix.inp -> GenIA1.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   t_5>.
val resIA2 : ('a, G_GAC_I.InpJustMatrix.inp -> GenIA2.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
...
val resIA3 : ('a, G_GAC_I.InpJustMatrix.inp -> GenIA3.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   (t_5, (! t_2))>.
val resIA4 : ('a, G_GAC_I.InpJustMatrix.inp -> GenIA4.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
...
val resIV1 : ('a, G_GVC_I.InpJustMatrix.inp -> GenIV1.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
   ...
   t_4>.
val resIV2 : ('a, G_GVC_I.InpJustMatrix.inp -> GenIV2.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
...
val resIV3 : ('a, G_GVC_I.InpJustMatrix.inp -> GenIV3.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
   ...
   (t_4, (! t_2))>.
val resIV4 : ('a, G_GVC_I.InpJustMatrix.inp -> GenIV4.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
...
val resIV5 : ('a, G_GVC_I.InpJustMatrix.inp -> GenIV5.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
...
val resIV6 : ('a, G_GVC_I.InpJustMatrix.inp -> GenIV6.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
...
val resFA11 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA11.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   t_5>.
val resFA12 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA12.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
...
val resFA13 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA13.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   (t_5, (! t_2))>.
val resFA14 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA14.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
...
val resFA24 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA24.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
...
val resFA25 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA25.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
...
val resFA26 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA26.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   t_5>.
val resRA1 : ('a, G_GAC_R.InpJustMatrix.inp -> GenRA1.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   t_5>.
val resRA2 : ('a, G_GAC_R.InpJustMatrix.inp -> GenRA2.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
...
val resRA3 : ('a, G_GAC_R.InpJustMatrix.inp -> GenRA3.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   (t_5, (! t_2))>.
val resRA4 : ('a, G_GAC_R.InpJustMatrix.inp -> GenRA4.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   (t_5,
    if ((! t_9) = 0) then (* cross-stage persistent value (as id: zero) *)
     ...
     (((* cross-stage persistent value (as id: Num.minus_num) *)) (! t_8)),
    (! t_2))>.
val resFA5 : ('a, G_GAC_F.InpMatrixMargin.inp -> GenFA5.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   ...
   t_5>.
val resFA6 : ('a, G_GAC_F.InpMatrixMargin.inp -> GenFA6.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy (fst a_1))) in
...
val resFA7 : ('a, G_GAC_F.InpMatrixMargin.inp -> GenFA7.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy (fst a_1))) in
   ...
   (t_5, (! t_2))>.
val resFA8 : ('a, G_GAC_F.InpMatrixMargin.inp -> GenFA8.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy (fst a_1))) in
   ...
   (t_5, (), (! t_2))>.
val resFA9 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA9.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   (t_5, (! t_8))>.
val resFA31 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA31.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   (t_5, t_13, (! t_10))>.
val resFA32 : ('a, G_GAC_F.InpJustMatrix.inp -> GenFA32.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_5 = (Array.map (fun x_4 -> (Array.copy x_4)) (Array.copy a_1)) in
   ...
   (t_5, (! t_10))>.
val resZp3 : ('a, G_GVC_Z3.InpJustMatrix.inp -> GenZp3.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
   ...
   (t_4,
    ...
    (! t_2), (! t_9))>.
val resZp19 : ('a, G_GVC_Z19.InpJustMatrix.inp -> GenZp19.Output.res) code =
  .<fun a_1 ->
   let t_2 = (ref 0) in
   let t_3 = (ref 0) in
   let t_4 = {arr = (Array.copy a_1.arr)} (a_1) in
   ...
   (t_4,
    ...
    (! t_2), (! t_9))>.
val rFA1 : G_GAC_F.InpJustMatrix.inp -> GenFA1.Output.res = <fun>
...
val rFV5 :
  GVC_F.Dom.v Domains_code.container2dfromvector -> GVC_F.contr * float * int =
  <fun>
val rIA1 : GAC_I.Dom.v array array -> GAC_I.Dom.v array array = <fun>
...
val rIV6 :
  GVC_I.Dom.v Domains_code.container2dfromvector ->
  GVC_I.contr * int * int * GEF.PermList.perm_rep = <fun>
val rFA11 : G_GAC_F.InpJustMatrix.inp -> GAC_F.Dom.v array array = <fun>
val rFA12 : G_GAC_F.InpJustMatrix.inp -> GAC_F.contr * float = <fun>
val rFA13 : G_GAC_F.InpJustMatrix.inp -> GAC_F.contr * int = <fun>
val rFA14 : G_GAC_F.InpJustMatrix.inp -> GAC_F.contr * float * int = <fun>
val rFA24 :
  G_GAC_F.InpJustMatrix.inp ->
  GAC_F.contr * float * int * GEF.PermList.perm_rep = <fun>
val rFA25 :
  G_GAC_F.InpJustMatrix.inp ->
  GAC_F.contr * float * int * GEF.RowVectorPerm.perm_rep = <fun>
val rFA26 : G_GAC_F.InpJustMatrix.inp -> GAC_F.Dom.v array array = <fun>
val rRA1 : G_GAC_R.InpJustMatrix.inp -> GAC_R.Dom.v array array = <fun>
val rRA2 : G_GAC_R.InpJustMatrix.inp -> GAC_R.contr * Num.num = <fun>
val rRA3 : G_GAC_R.InpJustMatrix.inp -> GAC_R.contr * int = <fun>
val rRA4 : G_GAC_R.InpJustMatrix.inp -> GAC_R.contr * Num.num * int = <fun>
val rFA5 : G_GAC_F.InpMatrixMargin.inp -> GAC_F.Dom.v array array = <fun>
val rFA6 : G_GAC_F.InpMatrixMargin.inp -> GAC_F.contr * float = <fun>
val rFA7 : G_GAC_F.InpMatrixMargin.inp -> GAC_F.contr * int = <fun>
val rFA8 : G_GAC_F.InpMatrixMargin.inp -> GAC_F.contr * unit * int = <fun>
val rFA9 : G_GAC_F.InpJustMatrix.inp -> GAC_F.contr * GEF.PermList.perm_rep =
  <fun>
val rFA31 :
  G_GAC_F.InpJustMatrix.inp ->
  GAC_F.contr * GAC_F.contr * GEF.PermList.perm_rep = <fun>
val rFA32 : G_GAC_F.InpJustMatrix.inp -> GAC_F.contr * GEF.PermList.perm_rep =
  <fun>
val rZp3 :
  G_GVC_Z3.InpJustMatrix.inp ->
  GVC_Z3.contr * int * int * GEF.PermList.perm_rep = <fun>
val rZp19 :
  G_GVC_Z19.InpJustMatrix.inp ->
  GVC_Z19.contr * int * int * GEF.PermList.perm_rep = <fun>
...
val ia5 : int array array list =
  [[|[|1|]|]; [|[|1; 2; 3|]; [|4; 13; 5|]; [|-1; 3; 0|]|];
   ...
   [|[|1; 2; 3|]; [|4; 13; 5|]; [|-1; 3; 0|]; [|0; 0; 0|]|];
   [|[|0; 2; 3|]; [|0; 13; 5|]; [|0; 3; 0|]|]]
val resI11 : GAC_I.Dom.v array array list =
...
val resI26 : (GVC_I.contr * int * int * GEF.PermList.perm_rep) list =
  [({arr = [|1|]; n = 1; m = 1}, 1, 1, []);
   ({arr = [|1; 3; 2; 0; 3; 5; 0; 0; 50|]; n = 3; m = 3}, 50, 3,
...
- : unit = ()
- : unit = ()
val resFA9 : GAC_F.contr * GEF.PermList.perm_rep =
...
- : unit = ()
val resFV5 : (GVC_F.contr * float * int) list =
  [({arr = [|1.|]; n = 1; m = 1}, 1., 1);
   ({arr =
...
val resF24 : (GAC_F.contr * float * int * GEF.PermList.perm_rep) list =
  [([|[|1.|]|], 1., 1, []);
   ...
   ([|[|0.; 10.; 5.|]; [|0.; 0.; 2.|]; [|0.; 0.; 0.|]|], 0., 2,
    [Code.RowSwap (1, 0)])]
val resF25 : (GAC_F.contr * float * int * GEF.RowVectorPerm.perm_rep) list =
  [([|[|1.|]|], 1., 1, [|0|]);
   ([|[|4.; 13.; 5.|]; [|0.; 6.25; 1.25|]; [|0.; 0.; 2.|]|], 50., 3,
    [|1; 2; 0|]);
   ([|[|4.; 13.; 5.; 0.|]; [|0.; 6.25; 1.25; 0.|]; [|0.; 0.; 2.; 0.|]|], 50.,
