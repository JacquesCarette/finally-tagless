(*  
 *  This is an ML version of Oleg's Haskell IncopeTypecheck.
...
type uexp = UInt of int 
          | UBool of bool
          | UAdd of uexp * uexp
          | UIf of uexp * uexp * uexp
          | UVar of varname
          | UL of varname * uexp * uexp
          | UApp of uexp * uexp
...
type gamma = varname * typerep list
