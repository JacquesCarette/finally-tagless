...
% fig:tag-problem part (e) was here
...
% fig:tag-problem part (g) was here
Second, the |lookup|
...
.
% fig:tag-problem part (h) was here
...
.
% fig:tag-final-proposal part (a) was here
...
.
% fig:tag-final-proposal part (b) was here
...
.
% fig:tag-final-proposal part (c) was here
...
.
% fig:tag-final-proposal part (d) was here
...
%aplas
\footnote{Due to the most severe lack of space, we cannot describe
these features and refer the reader to the accompanying code.}%
.
\end{itemize*}
...
% aplas-specific
For variety, the source code shows another interpreter, |L|, which measures
...
The accompanying code shows the corresponding Haskell implemention. 
\begin{comment}
