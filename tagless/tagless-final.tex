...
metalanguage with a simple type system
\citep{hindley-principal,milner-theory}.  In this \emph{final} rather
...
interpretation exactly as it was posed in \citet{WalidICFP02} and
\citet{xi-guarded}.  We use their running examples and achieve the
...
related work section in \citet{Guillemette-Monier-PLPV}, especially
...
forming of ill-typed DSL terms \citet{Lava,Rhiger-thesis}. However,
the universal type still remains (|Bit| and |NumSig| in Lava
\citet{Lava}, |Raw| and |Term| in \citet[Fig 2.2,
...
\citet{Rhiger-thesis}. In contrast, our proofs become trivial.
...
\citet{Pfenning-Lee} conclude that partial evaluation and program
...
\citet{Morrisett-intensional,Generic-Haskell}. Our running HOAS
example however, includes |fix|, which cannot be handled by the
intensional type analysis \citet{xi-guarded}.  Our final approach
seems related to \citearound{'s approach to HOAS via catamorphism and
  anamorphism}\citet{Washburn-Weirich-boxes}.
