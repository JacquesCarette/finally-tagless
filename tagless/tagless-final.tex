...
This paper shows how to eliminate type-checking overhead, whether in the
...
\ccshan{Make the point that the error messages are nice because we also
metacircularly take advantage of any niceness in the error messages of
the metalanguage implementation!}
...
\ccshan{Fix the citations in the preceding sentence.}
...
other is found in an early form in Schism \citep[\S5]{consel-schism-93}. 
\ccshan{Refer to PE tradition and (earlier, even) the category-theory
...
\ccshan{The following should be far from the first mention of optimality
in this paper.}
