...
\emph{object} or \emph{subject} language, whereas the host language is the
...
with the host environment \oleg{Cite Hudaks' survey and perhaps say a
  couple of more words}.  If the metalanguage supports \emph{staging}, then
