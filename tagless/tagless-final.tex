...
\subsection{Avoiding higher-rank polymorphism}
...
Instead of adding higher-rank polymorphism to our object language (along
...
waiting to be plugged into a context as a higher-rank abstraction over
the context.  Whereas our object language does not support higher-rank
abstraction, our metalanguages do, so they can type-check an object term
separately from its interpreter---as a functor from a |Symantics| module
(in OCaml) or a value with a |Symantics| constraint (in Haskell).  Thus
