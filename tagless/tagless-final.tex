...
\footnote{We use de Bruijn indices here to make the comparison with
\citep{WalidICFP02} simpler}.
...
MetaOCaml \cite{metaocaml}) and standard Haskell. The complete code is
...
premise in the very first step is not valid.
