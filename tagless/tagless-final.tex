...
\end{code}
In HOAS, the type of |lapp| is that of function application with
...
interpreter is still CBN, so evaluating |app ef ea| may not
evaluate |ea|, but evaluating |lapp ea ef| does.
