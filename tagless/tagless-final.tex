...
\item These interpreters use no type tags
    ...
    Haskell 98 and ML, by baking into their interface an inductive
...
\citets{sumii-hybrid} deforestation of syntax
...
It is known how to write such a parser and type-checker,
whether using fancy types \citep{Guillemette-Monier-PLPV,haskell-list,WalidICFP02} or not \citep{baars-typing}.
We have ourselves implemented a parser and type-checker for our object
language, which returns (either a parse or type error or) a finally
...
\Citet{sumii-hybrid} also use Sperber and Asai's construction,
to combine online
