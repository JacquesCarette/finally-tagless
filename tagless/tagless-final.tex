...
We find HOAS to be more convenient. We do present the version of our
developement using de Bruijn indices in the accompanying source code, file
|incope-dB.ml|.
...
type of a GADT value precludes certain constructors. Although this
is the implementation problem of GHC,
...
$\si\Encode{e}$ is too observationally equivalent to $e$ but less
efficient (``observing'' $\si\Encode{e}$ takes more resources). A
