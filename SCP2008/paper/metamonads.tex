...
code generation (see \S\ref{sec:det} for an example).
...
available.}
\oleg{well, we can say IntegerDomain : DOMAIN with type v = int}
...
the LU generator (\S\ref{sec:det} and below), instead of
