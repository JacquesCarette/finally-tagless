...
\DefineVerbatimEnvironment{code2}{Verbatim}{xleftmargin=\ourmathindent,commandchars=\\\{\},fontsize=\footnotesize}
...
be rejected by the compiler at generation time rather than at a later
stage.
\end{abstract}
...
|store v| construct computations that read and write the state. 
...
|loopM| is the analogue of the for-loop.
...
maintauining the state

cf Atlas: no unbound variable.
state-changing monad...
extensible object... No worry about init
lots of infrastructure...

mention MLTon.
The reason openrec are so challenging in Ocaml is
because we want to store pieces of code, and exceptions
can't be polymorphic...
The benefit of explicit tags: no need to care about
sharing of modules like Tracking, etc. fewer errors.
