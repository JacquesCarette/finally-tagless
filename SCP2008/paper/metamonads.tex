...
let swap_cols a (n,m) c j =
  ...
  in loop c j
\end{code}
We refer to the $a_{ij}$\hyp th element of the matrix as |a.(i*m+j)|,
...
nonzero minimum absolute value. The function returns the value of the
...
many functions particular to $n=2$.  For example, we have rows and
